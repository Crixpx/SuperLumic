    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("SuperLumic Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SuperLumic address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and superlumic: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About SuperLumic Core"), this);
    aboutAction->setStatusTip(tr("Show information about SuperLumic Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SuperLumic Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SuperLumic addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SuperLumic addresses"));
    ...
    openAction->setStatusTip(tr("Open a superlumic: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the SuperLumic Core help message to get a list with possible SuperLumic Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("SuperLumic Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SuperLumic network", "", count));
}
...
{
    QString strTitle = tr("SuperLumic Core"); // default title
    ...
    // Append title to "SuperLumic Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
