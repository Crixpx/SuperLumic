...
2. run superlumicd with -printalert or -sendalert like this:
   /path/to/superlumicd -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.superlumic.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/SuperLumic Core:0.12.0.58/"));
