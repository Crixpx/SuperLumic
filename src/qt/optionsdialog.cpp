    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("SLC-light"), QVariant("light"));
    ui->theme->addItem(QString("SLC-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("SLC-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("SLC-traditional"), QVariant("trad"));
