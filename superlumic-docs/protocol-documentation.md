Protocol Documentation - 0.0.1
=====================================

This document describes the protocol extensions for all additional functionality build into the SuperLumic protocol. This doesn't include any of the Bitcoin procotol, which has been left in tact in the SuperLumic project. For more information about the core protocol, please see https://en.bitcoin.it/w/index.php?title#Protocol_documentation&action#edit

Protocol is identical to GoByte 0.12.1
...
| Field Size | Field Name | Data type | Description |
| ---------- | ----------- | --------- | -------- |
| 41 | vin | CTxIn | The unspent output which is holding 1000 SLC
| # | addr | CService | Address of the main 1000 SLC unspent output
| 33-65 | pubKeyCollateralAddress | CPubKey | CPubKey of the main 1000 SLC unspent output
