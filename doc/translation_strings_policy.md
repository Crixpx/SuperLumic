...
This document provides guidelines for internationalization of the SuperLumic Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        ...
        <translation>
            <numerusform>%n active connection to SuperLumic network</numerusform>
            <numerusform>%n active connections to SuperLumic network</numerusform>
        </translation>
    </message>
