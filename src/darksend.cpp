...
{
    if(fLiteMode) return; // ignore all SuperLumic related functionality
...
/*
    ...
    allow endless transaction that would bloat SuperLumic and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("superlumic-privatesend");
