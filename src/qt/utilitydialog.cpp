    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("SuperLumic Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About SuperLumic Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  superlumic-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the SuperLumic in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 SLC, 0.1 SLC, 1 SLC and 10 SLC -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://superlumiccoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://superlumiccoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("SuperLumic Core is shutting down...") + "<br /><br />" +
