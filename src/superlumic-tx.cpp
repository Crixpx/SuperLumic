...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("SuperLumic Core superlumic-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  superlumic-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded superlumic transaction") + "\n" +
              "  superlumic-tx [options] -create [commands]   " + _("Create hex-encoded superlumic transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded superlumic transaction
