...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "SuperLumicNetwork") type = SuperLumicNetwork;
    if(strType == "SuperLumicNetworkVariable") type = SuperLumicNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == SuperLumicNetwork) s = "SuperLumicNetwork";
    if(type == SuperLumicNetworkVariable) s = "SuperLumicNetworkVariable";
