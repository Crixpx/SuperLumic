...
This mechanism has been integrated into Bitcore-Node-SuperLumic which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/superlumiccoin/insight-api-superlumic#web-socket-api](https://github.com/superlumiccoin/insight-api-superlumic#web-socket-api) 
* API: [https://github.com/superlumiccoin/insight-api-superlumic#instantsend-transactions](https://github.com/superlumiccoin/insight-api-superlumic#instantsend-transactions) 
...
By default, the SuperLumic Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the SuperLumic Core daemon:
