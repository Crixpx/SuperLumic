 ...
 *
 *   // network
 *   CSuperLumicNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.superlumic.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CSuperLumicNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CSuperLumicNetwork(UniValue objIn)
    {
...
// // can be under: SuperLumicNetwork
// //   -- signature requirements : Key1(User)
// class CSuperLumicNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == SuperLumicNetwork);
//     // }
