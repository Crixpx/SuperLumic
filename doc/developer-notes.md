...
SuperLumic Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as SuperLumic Core, where everyone uses
...
pay attention to for reviewers of SuperLumic Core code.

General SuperLumic Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: SuperLumic Core uses tinyformat, which is type safe. Leave them out to avoid confusion
